...
INFO = SimpleNamespace(
    program='Proton',
    description='Telemetric tools for Proton and all its sub-modules',
...
while True:
    ...
    lock_file = CWD.joinpath(f'Proton.{PROCESS_ID}.lock') if PROCESS_ID else CWD.joinpath(f'Proton.lock')
